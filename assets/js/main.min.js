...
$(document).ready(function() {
	burger.on( "click", function() {
		if (burger.hasClass('active') == false)
		{
			...
			burger.parents().find('._navToggle').addClass('active');
...
$(document).on('click', function (event) {
	if (!$(event.target).closest('._navToggle').length && !$(event.target).closest(burger).length) {
		burger.removeClass('active');
		burger.parents().find('._navToggle').removeClass('active');
